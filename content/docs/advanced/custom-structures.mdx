...
Quick links:
- [Structures](/docs/api/Structures.Variable)
- [Player](/docs/api/Player.Class)
- [Node](/docs/api/Node.Class)
- [LyricsManager](/docs/api/LyricsManager.Class)
- [InferCustomStructure](/docs/api/InferCustomStructure.TypeAlias)
